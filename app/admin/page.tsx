                  ...
                  <div className="space-y-4 text-left animate-fade-in">
                    ...
                    <div className="bg-slate-900/60 p-4.5 rounded-2xl border border-slate-800 space-y-3.5">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] font-medium font-mono text-slate-300">
                        ...
                        <a href={`https://wa.me/${selectedRecitation.phone.replace(/\+/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#1C8DC8] truncate">
                    ...
                    <form onSubmit={submitFeedback} className="space-y-4 pt-1">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          placeholder="Write Makharij, Tajweed analysis and clear recommendations here..."
