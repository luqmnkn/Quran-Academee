...
export const COURSES: Course[] = [
  {
    ...
    fullDescription: 'This course is the gateway to reading the Quran. Designed for children who are starting from scratch and adults who want to correct their pronunciation. Using the world-renowned Alqaida Almadania syllabus, we teach you letter shapes, connections, vowel sounds (Harakat), and the foundational phonetic elements needed to recite Quranic verses with confidence.',
    icon: 'BookOpen',
